...
class SessionsControllerTest < ActionDispatch::IntegrationTest
  ...
  def test_should_login_user_with_valid_credentials
    post session_path, params: { login: { sitename: @site.sitename, password: @site.password } },
      as: :json
  ...
  def test_shouldnt_login_user_with_invalid_credentials
    post session_path, params: { login: { sitename: @site.sitename, password: "invalid password" } },
      as: :json
